...
public class UrlController { 
	...
	String description
		...
		if(url != null) { 
			...
			var shortUrl =
					this.urlService.convertToShortUrl(urlObj); 
			UrlResponse entity;
			if(username != null) {
				entity= new UrlResponse( new  URL(ServletUriComponentsBuilder.fromCurrentContextPath().toUriString()+"/r/"+username+"/"+shortUrl) ); 
			}else {
				entity= new UrlResponse( new  URL(ServletUriComponentsBuilder.fromCurrentContextPath().toUriString()+"/r/"+shortUrl) ); 
			}  
